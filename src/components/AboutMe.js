          ...
          <div className="text-boxes">
            <div>
              ...
              <p className="about-text">
                I’m Kristoffer, a 25-year-old enthusiast with a passion for
                house music, playing bass guitar, and staying active through
                volleyball and social engagements. I’m known for my creativity,
                humor, and genuine care for others. I thrive on finding
                innovative solutions to problems and always strive to see the
                bigger picture. My diverse interests and proactive approach help
                me bring a unique perspective to everything I do.
              </p>
            </div>
            <div>
              ...
              <p className="about-text">
                ...
                eager to broaden my expertise by delving into backend
                technologies and becoming a well-rounded full-stack developer. I
                am committed to continuous learning and professional growth, and
                I believe that a positive and supportive work environment is
                essential for both personal and career development. My goal is
                to enhance my capabilities, embrace new challenges, and make a
                meaningful impact in my carrer!
              </p>
            </div>
          </div>
        </div>
